...
def main_plot(exp_name, data_name=['todo']):
    tag_space = ['Train_EnvstepsSoFar', 'Train_AverageReturn', 'Eval_AverageReturn']
    file_name_a = data_name
    ...
    set_plot_env(iterations, rewards_dict, exp_name)


if __name__ == '__main__':
    main_plot('test1', ['no_dist_reward'])